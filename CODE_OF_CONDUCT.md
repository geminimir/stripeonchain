...
We as members, contributors, and maintainers pledge to make participation in CryptoVerifyHook a harassment-free experience for everyone, regardless of age, body size, disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
This Code of Conduct applies within all project spaces, including the issue tracker, pull requests, discussions, and any other communication channel used by the project. It also applies when an individual is representing the project in public spaces.
